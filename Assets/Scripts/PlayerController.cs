...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        powerUpIndiactor[0].transform.position = transform.position + new Vector3(0, -0.5f, 0);
        powerUpIndiactor[1].transform.position = transform.position + new Vector3(0, -0.5f, 0);
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(other.gameObject.CompareTag("Powerup"))
        {
            ...
            powerUpIndiactor[0].SetActive(true);
    ...
    IEnumerator PowerupCountdownRoutine()
    {
        ...
        powerUpIndiactor[0].SetActive(false);
